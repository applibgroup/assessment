...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ViewHolder> {
    ...
    public ItemAdapter(Context context, ArrayList<Article> items) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        LinearLayout layout = (LinearLayout) inflater.inflate(R.layout.items, null);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int i) {
        ...
        holder.mybutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //intent.putExtra("source",item.getSource().getName());
                intent.putExtra("time",item.getPublishedAt());
                intent.putExtra("desc",item.getDescription());
                intent.putExtra("imageUrl",item.getUrlToImage());
