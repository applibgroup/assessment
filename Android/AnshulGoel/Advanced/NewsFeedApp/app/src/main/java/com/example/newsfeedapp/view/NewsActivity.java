...
import com.example.newsfeedapp.adapter.NewsListAdapter;
...
import com.example.newsfeedapp.viewmodel.NewsResource;
...
public class NewsActivity extends DaggerAppCompatActivity implements NewsListAdapter.OnNewsClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsError = (TextView) findViewById(R.id.news_error);
        initViewModel();
        getNewsList();
        setupRecyclerView();
    }
    ...
    private void initViewModel() {
        viewModel = new ViewModelProvider((ViewModelStoreOwner) this, providerFactory).get(NewsViewModel.class);
        viewModel.init();
    }
    ...
    private void getNewsList() {
        ...
        viewModel.getNewsList()
                .observe((LifecycleOwner) this, new Observer<NewsResource<News>>() {
                    @Override
    ...
    public void onSaveClick(int position) {
        ...
        if (!savedState) {
            viewModel.saveNewsItem(position).observe((LifecycleOwner) this, new Observer<Boolean>() {
                @Override
