...
public class MainActivity extends AppCompatActivity
{
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Log.d("ABCEmail", "firebaseAuthWithGoogle:" + account.getEmail());
                Toast.makeText(MainActivity.this,"Verifying... Please wait!", Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // If sign in fails, display a message to the user.
                            Log.d("ABC", "signInWithCredential:failure", task.getException());
                        }
                    }
                });
    ...
    {
        Intent intent = new Intent(MainActivity.this, ActivityLogged.class);
