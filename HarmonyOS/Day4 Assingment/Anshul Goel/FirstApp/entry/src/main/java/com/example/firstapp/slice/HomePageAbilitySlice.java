...
public class HomePageAbilitySlice extends AbilitySlice {
    ...
    public void onStart(Intent intent) {
        ...
        button2Animation.setDuration(8000).moveFromX(80).moveToX(590).rotate(90).alpha(1).setLoopedCount(-1).setCurveType(Animator.CurveType.CYCLE);
        welcome.setBindStateChangedListener(new Component.BindStateChangedListener() {
            @Override
