...
public class SignupAbilitySlice extends AbilitySlice {
            ...
            public void onClick(Component component) {
                ...
                if(checkData()){
                    ...
                    new ToastDialog(getContext())
                            .setText("Provide vaild information")
                            .setOffset(0,20)
                            .show();
                }
            }
    ...
    private void showCommonDialog(){
        ...
        commonDialog.setContentText("Want to Login?");
        commonDialog.setAutoClosable(true);
        commonDialog.setSize(800,400);
        commonDialog.setButton(IDialog.BUTTON1,"Yes",(iDialog, i) -> {
            Intent intent = new Intent();
            intent.setParam("myapp5sankuyogeshemailid",emailString);
            intent.setParam("myapp5sankuyogeshpassword",passwordString);
