...
public class SignupAbilitySlice extends AbilitySlice {
    ...
    private void showCommonDialog() {
        ...
        commonDialog.setTitleText(getString(ResourceTable.String_Success));
        commonDialog.setContentText(getString(ResourceTable.String_Dialog_msg));
        commonDialog.setAutoClosable(true);
        commonDialog.setSize(Width,Height);
        commonDialog.setButton(IDialog.BUTTON1,"YES",(iDialog, i) -> {
           Intent intent1= new Intent();
            intent1.setParam(getString(ResourceTable.String_Email),emailID.getText());
            intent1.setParam(getString(ResourceTable.String_Password),password.getText());
