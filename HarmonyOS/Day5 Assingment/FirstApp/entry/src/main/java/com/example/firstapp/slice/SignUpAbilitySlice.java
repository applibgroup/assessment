...
public class SignUpAbilitySlice extends AbilitySlice {
    ...
    private TextField fnametext, lnametext, emailtext, passwordtext, mobiletext;
    private Text fnameerror, lnameerror, emailerror, passworderror, mobileerror;
    ...
    private void showCommonDialog() {
        ...
        commonDialog.setSize(1000,400);
        commonDialog.setButton(IDialog.BUTTON1,"YES",(iDialog, i) -> {

            Intent intent1 = new Intent();
            intent1.setParam("email", emailtext.getText());
            intent1.setParam("password", passwordtext.getText());
            present(new LoginAbilitySlice(), intent1);
            iDialog.destroy();
        });
        commonDialog.setButton(IDialog.BUTTON2,"NO",(iDialog, i) -> {
            new ToastDialog(getContext()).setText("No Clicked").show();
            iDialog.destroy();
        });
        commonDialog.show();
    }
